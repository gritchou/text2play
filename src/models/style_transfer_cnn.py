...
def asset_loader(image_name, device, convert_to_rgb=False):
...
def get_input_optimizer(input_img):
    ...
    return optimizer
def style_transfer(content_img_path, style_img_path, num_steps,
    ...
    style_img= resize(content_img,style_img)
